...
const SFX = {
  ...
  // -- added for the physics demos (breakout / pong) --
  paddle: { type: 'square', vol: 0.09, notes: [ { f: 300, d: 0.06, f2: 520 } ] },
  brick: { type: 'square', vol: 0.09, notes: [
    { f: 660, d: 0.04 }, { f: 440, t: 0.03, d: 0.09, f2: 330 } ] },
  hit: { type: 'square', vol: 0.07, notes: [ { f: 520, d: 0.05, f2: 300 } ] },
  power: { type: 'square', vol: 0.10, notes: [
    { f: 523.25, d: 0.05 }, { f: 659.25, t: 0.05, d: 0.05 },
    { f: 783.99, t: 0.1, d: 0.05 }, { f: 1046.5, t: 0.15, d: 0.18 } ] },
  die: { type: 'sawtooth', vol: 0.09, notes: [
    { f: 330, d: 0.14, f2: 220 }, { f: 220, t: 0.14, d: 0.24, f2: 110 } ] },
  levelup: { type: 'square', vol: 0.10, notes: [
    { f: 523.25, d: 0.07 }, { f: 659.25, t: 0.07, d: 0.07 },
    { f: 783.99, t: 0.14, d: 0.07 }, { f: 1046.5, t: 0.21, d: 0.2 } ] },
};
