...
export class HUD {
  ...
  // Raw-text setters for games that show something other than lives/timer
  // (the text RPG uses these for party HP and floor progress).
  setLabel(text) {
    this.livesEl.textContent = text;
  }
